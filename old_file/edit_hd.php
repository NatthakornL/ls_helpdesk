                                    ...
                                    <div class="album">
                                        <div class="imgContainer">
                                            <div id="image_preview"
                                                style="width:100%; height: 100%; background-color: #baff95;">
                                                ...
                                                <?php
                                                    ...
                                                    if($query->num_rows > 0){
                                                        while($row = $query->fetch_assoc()){
                                                            $imageURL = 'images/uploadPic/'.$row["images"];
                                                    ?>
                                                <img src="<?php echo $imageURL; ?>" id="c_image_preview" alt=""
                                                    width="100%" height="100%" />
                                                <?php }
                                                    }else{ ?>
                                                <img src="images/noimg.png" id="c_image_preview" alt="" width="30%"
                                                    height="30%" />
                                                <?php } ?>
                                            </div>
                                        </div>
