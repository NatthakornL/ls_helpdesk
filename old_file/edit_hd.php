    ...
    <div class="container">
        <main>
            <div class="col"
                ...
                <!---------------------------------------------->
                <form name="form" method="post" action="edit.php" style="text-align: left; margin: auto; ">
                    <!--
...
-->
                    ...
                    <?php 
                            if(isset($_GET['id'])){
                                $noman = mysqli_real_escape_string($connect, $_GET['id']);
                ...
                <div style="width: 100%; text-align: center;">
                    <li><input class="btnaddata" type="submit" name="submit" onclick="//update()" value="เเก้ไขข้อมูล"
                        ...
                        <span style="margin-left: 3%;"><input class="btnaddata" type="button" name="" id="butcancel"
                                value="กลับหน้าหลัก" onclick="document.location='index.php'"
